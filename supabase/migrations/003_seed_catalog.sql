-- Auto-generated catalog seed (118 tools)
...
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('coding', 'Coding', 'Code2', 'AI coding assistants, agents, and app builders.', 3) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('chatbots', 'Chatbots', 'Brain', 'Conversational AI assistants and LLM chat apps.', 4) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('productivity', 'Productivity', 'Calendar', 'Writing, notes, meetings, and workflow automation.', 5) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('voice-ai', 'Voice AI', 'Volume2', 'Voice cloning, TTS, transcription, and dubbing.', 6) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('music-ai', 'Music AI', 'Speech', 'AI music composition and audio generation.', 7) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('research-ai', 'Research AI', 'Compass', 'Literature search, citations, and academic tools.', 8) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('marketing-ai', 'Marketing AI', 'Activity', 'Copy, ads, SEO, and social content generation.', 9) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
INSERT INTO categories (id, name, icon, description, sort_order) VALUES ('design-ai', 'Design AI', 'Layers', 'UI, branding, presentations, and design automation.', 10) ON CONFLICT (id) DO UPDATE SET name = EXCLUDED.name, icon = EXCLUDED.icon, description = EXCLUDED.description, sort_order = EXCLUDED.sort_order;
